  ...
  return (
    <div>
          ...
          menu: {
            ...
            items: [
              ...
              },
              {
                key: 'react',
                label: (
                  <span>React {renderBadge(9, activeKey === 'react')}</span>
                ),
              },
              {
                key: 'node',
      ...
      <div className="grid grid-cols-6 gap-4 p-10">
        ...
        >
          <img
            className="h-16 w-16 rounded-2xl p-4 shadow-2xl md:h-20 md:w-20"
            src="https://avatars.githubusercontent.com/u/1961952?v=4"
            alt=""
          />
          <div className="w-full truncate py-2 text-center">
            style-components
          </div>
        </div>
      </div>
